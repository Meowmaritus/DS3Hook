...
namespace DS3Hook.XInput
{
    public sealed partial class Gamepad
    {
        public class PS4 : GamepadBase
        {
            ...
            public bool    OPTIONS  { get => curState.Button[Button.MenuPrimary];         set => curState.Button[Button.MenuPrimary] = value; }
            public bool    SHARE    { get => curState.Button[Button.MenuSecondary];       set => curState.Button[Button.MenuSecondary] = value; }
            ...
            public bool    PrevOPTIONS  => prevState.Button[Button.MenuPrimary];
            public bool    PrevSHARE    => prevState.Button[Button.MenuSecondary];
            ...
            //Extra Options:
            public bool TouchRight { get => curState.Button[Button.MenuPrimary]; set => curState.Button[Button.MenuPrimary] = value; }
            public bool TouchLeft { get => curState.Button[Button.MenuSecondary]; set => curState.Button[Button.MenuSecondary] = value; }

            public bool PrevTouchRight => prevState.Button[Button.MenuPrimary];
            public bool PrevTouchLeft => prevState.Button[Button.MenuSecondary];
        }
    }
}

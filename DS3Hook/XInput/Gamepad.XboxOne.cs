...
namespace DS3Hook.XInput
{
    ...
    {
        public class XboxOne : GamepadBase
        {
            ...
            public bool    Menu   { get => curState.Button[Button.MenuPrimary];         set => curState.Button[Button.MenuPrimary] = value; }
            public bool    View   { get => curState.Button[Button.MenuSecondary];       set => curState.Button[Button.MenuSecondary] = value; }
            public bool    Xbox   { get => curState.Button[Button.MenuTertiary];        set => curState.Button[Button.MenuTertiary] = value; }
            ...
            public bool    PrevMenu   => prevState.Button[Button.MenuPrimary];
            public bool    PrevView   => prevState.Button[Button.MenuSecondary];
            public bool    PrevXbox   => prevState.Button[Button.MenuTertiary];
